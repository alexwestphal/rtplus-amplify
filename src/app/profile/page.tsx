...
export default function ProfilePage() {
    return <div className="mx-auto max-w-7xl space-y-8 sm:space-y-10">
        ...
        <Card>
            <CardContent>
                <h2 className="text-base font-semibold leading-7 text-gray-900">D4H API Keys</h2>
                <p className="mt-1 text-sm leading-6 text-gray-500">Connect to D4H</p>
                ...
                <button type="button" className="text-sm font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
                    <span aria-hidden="true">+</span> Add another key
                </button>
                </div>
            </CardContent>
        </Card>

...
export interface WhoamiResponse {
    ...
    members: {
        ...
        permissions?: Record<
            ...
            , 
            Record<PermissionType, boolean | undefined>>
    }[]
};

type PermissionType = 'APPROVE' | 'ARCHIVED' | 'ASSIGN_UNASSIGED' | 'CREATE' | 'CREATE_CUSTOM_FIELDS' | 'CREATE_SECURE' | 'DEFAULT_ACCESS' | 'DELETE' | 'DELETE_CUSTOM_FIELD' | 'DELETE_SECURE' | 'DOWNLOAD_SECURE' | 'DRAFT' | 'EXPORT' | 'LIST' | 'READ' | 'READ_SECURE' | 'UPDATE' | 'UPDATE_CUSTOM_FIELDS' | 'UPDATEOWN' | 'UPDATE_SECURE' | 'UPDATE_STATUS' | 'UPDATE_RESULT'
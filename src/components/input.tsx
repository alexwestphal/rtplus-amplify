/**
 * Input related components derived from Catalyst UI.
 */
...
type InputProps = { className?: string, type?: 'email' | 'number' | 'password' | 'search' | 'tel' | 'text' | 'url' | DateType } & Omit<Headless.InputProps, 'className'>
...
export type DebouncedInputProps = { value: string, onChange: (value: String) => void, debounce?: number } & Omit<React.InputHTMLAttributes<HTMLInputElement>, 'value' | 'onChange'>

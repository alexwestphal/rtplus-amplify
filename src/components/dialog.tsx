...
export type DialogProps = Omit<Headless.DialogProps, 'className'> & {
    size?: keyof typeof sizes,
    className?: string,
    children: React.ReactNode
}

export default function Dialog({ size = 'lg', className, children, ...props }: DialogProps) {
...
export type DialogTitleProps = Omit<Headless.DialogTitleProps, 'className'> & {
    className?: string
}

export function DialogTitle({ className, ...props }: DialogTitleProps) {
    return <Headless.DialogTitle
        {...props}
...
export type DialogDescriptionProps = Omit<Headless.DescriptionProps<typeof Text>, 'className'> & { className?: string }

/**
 * Radio related components derived from Catalyst UI.
 */
...
type RadioGroupProps = { className?: string } & Omit<Headless.RadioGroupProps, 'className'>

export function RadioGroup({ className, ...props }: RadioGroupProps) {
    return <Headless.RadioGroup
        data-slot="control"
        {...props}
        className={clsx(
            className,
...
type RadioFieldProps = { className?: string } & Omit<Headless.FieldProps, 'className'>
...
type RadioProps = { color?: Color; className?: string } & Omit<Headless.RadioProps, 'className' | 'children'>

export default function Radio({ color = 'dark/zinc', className, ...props }: RadioProps) {
    return <Headless.Radio data-slot="control" {...props} className={clsx(className, 'group inline-flex focus:outline-none')}>

...
type SelectProps = { className?: string } & Omit<Headless.SelectProps, 'className'>

export const Select = forwardRef(function Select({ className, multiple, ...props }: SelectProps, ref: React.ForwardedRef<HTMLSelectElement>) {
    return <span
        data-slot="control"
        className={clsx([
            className,

/**
 * Switch related components derived from Catalyst UI.
 */
...
type SwitchFieldProps = { className?: string } & Omit<Headless.FieldProps, 'className'>
...
type SwitchProps = { color?: Color, className?: string } & Omit<Headless.SwitchProps, 'className' | 'children'>

export default function Switch({ color = 'dark/zinc', className, ...props }: SwitchProps) {
    return <Headless.Switch
        data-slot="control"
        {...props}
        className={clsx(
            className,
